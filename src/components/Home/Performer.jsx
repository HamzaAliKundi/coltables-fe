  ...
  const performers = [
    {
      ...
      description: 'Internationally renowned and the baddest bitch in Houston, will twirl with unmatched ...'
    },
    {
      id: 2,
      ...
      description: 'This beautiful and talented queen will twirl and leave you begging for an encore...'
    },
    {
      id: 3,
      ...
      name: 'Violet Chachki',
      description: 'She\'s a whirlwind of humor and high-energy charisma, lighting up the stage ...'
    },
    {
      id: 4,
      ...
      name: 'Eureka O\'Hara',
      description: 'She captivates & stuns audiences with her passionate performances...'
    },
    {
        id: 1,
  ...
  return (
    <div className="bg-gradient-to-b from-[#33001b] to-black text-white py-12 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center mb-6">
        ...
        <Link to="/performers" className="font-['Space_Grotesk'] font-normal text-[16px] leading-[100%] align-middle text-[#FF00A2]">
          VIEW ALL
        </Link>
      </div>
        ...
        >
          <div className="flex space-x-4 md:space-x-6 pb-4 min-w-max">
            {performers.map((performer) => (
              <div key={performer.id} className="w-[280px] md:w-[295.5px] h-[560px] md:h-[591px] relative">
                {/* Main Image */}
