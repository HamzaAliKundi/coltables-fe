...
const EventDetail = () => {
  ...
  return (
    <div className="flex justify-center items-center pt-16">
      <div className="flex gap-16 justify-center w-[80%]">
        <div className="p-2 relative">
          <img
            src={
              getEventsByVenuesById?.event?.image ||
              "/public/events/event-1.jpg.svg"
            }
            alt="event"
            className="w-[750px]"
          />
          <div className="absolute top-3 left-3 w-[70px] h-[70px] bg-gradient-to-b from-[#FF00A2] to-[#D876B5] rounded-full flex flex-col items-center justify-center">
            ...
            <span className="text-lg font-semibold text-[#ebd4e3] uppercase leading-none">
              {formatDateTime(getEventsByVenuesById?.event.startTime)?.slice(
                0,
                3
              )}
            </span>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="border-b-[3px] border-[#FF00A2] mb-3 pb-3 flex text-white">
                <div className="flex gap-20">
                  <div className="flex items-center gap-2">
                    <img
                      src="/public/events/Background.png"
                      alt="bullet"
                      className="w-5 h-5"
                    />
                  ...
                  <div className="flex items-center gap-2 ">
                    <img
                      src="/public/events/Background (1).png"
                      alt="bullet"
                      className="w-5 h-5"
                    />
                    <span className="truncate">
              ...
              <div className="border-b-[3px] border-[#FF00A2] mb-3 pb-3 flex text-white">
                <div className="flex gap-16">
                  <div className="flex items-center gap-2">
                    <img
                      src="/public/events/Background (3).png"
                      alt="bullet"
                      className="w-5 h-5"
                    />
                    <span className="truncate">
                  ...
                  <div className="flex items-center gap-2 ">
                    <img
                      src="/public/events/Background (2).png"
                      alt="bullet"
                      className="w-5 h-5"
                    />
                    <span className="truncate">
                      {getEventsByVenuesById?.event?.location ||
                        "The Montrose Country Club, Houston"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-b-[3px] border-[#FF00A2] mb-3 pb-3 flex  text-white">
                <div className="flex items-center gap-2">
                  <img
                    src="/public/events/Background (4).png"
                    alt="bullet"
                    className="w-5 h-5"
                  />
                  <span>
