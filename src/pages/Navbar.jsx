    ...
    <nav className="bg-black text-white h-[100px] w-full flex items-center z-30 px-8 md:px-20 justify-between relative">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Link to="/" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
              <FaHome /> Home
            </Link>
            <Link to="/performers" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
              <FaUsers /> Performers
            </Link>
            <Link to="/venues" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
              <FaMapMarkerAlt /> Venues
            </Link>
            <Link to="/events" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
              <FaCalendarAlt /> Events
            </Link>
            <Link to="/more" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
              <FaTh /> More
            </Link>
            <Link to="/registration" className="py-2" onClick={handleLinkClick}>Registration</Link>
            <Link to="/login" className="flex items-center gap-2 py-2" onClick={handleLinkClick}>
